...
original_notes = open('notas_empty.html', 'r', encoding="utf8").read()
...
def constructIndex():
    ...
    notes = original_notes.replace('<!-- card-container -->', html_notes)
    open('index.html', 'w', encoding="utf8").write(index)
    open('notas.html', 'w', encoding="utf8").write(notes)
